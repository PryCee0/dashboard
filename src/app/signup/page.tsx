...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#060606] relative overflow-hidden py-12">
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="bg-[#111110] border border-[#F5F0EB]/[0.06] p-8 relative overflow-hidden">
                    ...
                    <p className="text-[#F5F0EB]/50 text-sm mb-8">{t('signupSubtitle')}</p>
                  ...
                  focus:border-[#E41E2B]/50 focus:outline-none transition-colors placeholder:text-[#F5F0EB]/20"
                            />
                            {errors.name && (
                                <p className="text-[#FF2D3B] text-xs mt-1.5">{errors.name.message}</p>
                            )}
                        </div>
                  ...
                  focus:border-[#E41E2B]/50 focus:outline-none transition-colors placeholder:text-[#F5F0EB]/20"
                            ...
                            {errors.confirmPassword && (
                                <p className="text-[#FF2D3B] text-xs mt-1.5">{errors.confirmPassword.message}</p>
                            )}
                        </div>
                ...
                transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-x-0 disabled:hover:translate-y-0 disabled:hover:shadow-none"
                    ...
                    <p className="text-center text-sm text-[#F5F0EB]/40 mt-6">
                        {t('hasAccount')}{' '}
                        <Link href="/login" className="text-[#E41E2B] hover:text-[#FF2D3B] transition-colors font-medium">
                            {t('login')}
                        </Link>
                    </p>
                </div>
